...
const Counter = ( { counter, inc, dec, rst } ) => {
    return (
        ...
        <div className="counter-btn-container">
            ...
            <button className="btn btn-primary" id="inc" onClick={inc}>
            ...
            <button className="btn btn-primary" id="dec" onClick={dec}>
            ...
            <button className="btn btn-primary" id="rst" onClick={rst}>
